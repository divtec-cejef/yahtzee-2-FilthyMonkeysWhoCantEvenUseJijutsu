...
public class YahtzeeProcedural {
    ...
    public static void main(String[] args) {
        ...
        // Allow up to 2 rerolls (total 3 rolls)
        for (int i = 1; i <= 2; i++) {
            boolean rerolled = game.reLaunch();
            if (!rerolled) break;   // <--- instantly end loop if skipped
